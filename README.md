...
O provisionamento da infra seja qual for o do tipo de arquitetura pode ser feito tanto pelo cloudformation da própria AWS, mas aconselho utilizar o terraform para fazer o IAC (infraestrutura como código) necessário, pois o mesmo pode ser utilizado em outros cloud providers.